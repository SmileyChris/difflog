...
import type { Env, CreateProfileRequest, ProfileRow } from '../../types';
...
export const onRequestPost: PagesFunction<Env> = async (context) => {
  ...
  try {
    const body: CreateProfileRequest = await context.request.json();
    ...
    ).bind(id).first<Pick<ProfileRow, 'password_hash'>>();
